...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    // 2 saniye baad show karo
    const t1 = setTimeout(() => setVisible(true), 2000)
    // tooltip 5 saniye baad hide karo
  ...
  return (
    ...
    >
      {/* Tooltip */}
      {tooltip && (
        <div className="bg-surface-container-high border border-outline-variant/20 px-4 py-2 rounded-full text-sm font-body-md text-on-surface whitespace-nowrap shadow-lg">
          Chat on WhatsApp
        </div>
      )}
